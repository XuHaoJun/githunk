...
describe("React review surface on the current large branch", () => {
  test("paints the large changeset before highlight completion and stays windowed", async () => {
    const document = await loadReviewDocument(new GitRunner(process.cwd()), "main")
